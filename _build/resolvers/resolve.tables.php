...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('realtorx5_core_path', null,
                    $modx->getOption('core_path') . 'components/realtorx5/') . 'model/';
            $modx->addPackage('realtorx5', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/realtorx5/model/schema/realtorx5.mysql.schema.xml';
